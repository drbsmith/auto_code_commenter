...
Python parsing utilities. Mostly superceded by python_code sub-package
...
## Profile
	* number of lines: 138
	* number of characters: 3616
	* number of functions: 3

[generated by Auto Code Commenter at 2022-03-16 15:12:25. https://github.com/drbsmith/auto_code_commenter]
@package src """
...
def ParsePyScript(filename):
	"""!
	Parse a python script and return a list of individual lines

	@param filename: the path to a .py file to read and parse.

	@return (list, string) lines of code in the order found in the file, and the raw text read from the file.
	
	## Profile
	* line count: 57
	* characters: 1655
	* returns: ret, code_raw
	"""
...
def SetIndent(lines, indent):
	...
	@param indent: TODO_DOC
	@return TODO_DOC
	
	## Profile
	* line count: 22
	* characters: 352
	* returns: None, lines, ret
	"""
